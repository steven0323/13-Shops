...
def get_partner(num):
    ...
    partner = {1:"Yahoo奇摩購物中心",2:"Yahoo奇摩超級商城",3:"Yahoo奇摩拍賣",9:"friDay購物",18:"台灣樂天市場",20:"udn買東西",50:"東森購物",70:"淘寶天貓",90:"森森購物",122:"生活市集",256:"松果購物",271:"小三美日",286:"家樂福線上購物"}
    return partner[num]
...
def combine():
        ...
        if path.exists(m+d+"_6__result_1.csv") and path.exists(m+d+"_6__result_2.csv") and path.exists(m+d+"_6_result_3.csv"):
            hr = x.strftime("%H")
            mini = x.strftime("%M")
            ...
            error_.to_csv(m+d+"_6_Data.csv",index=False)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        m = x.strftime("%m")
        d = x.strftime("%d")
        if path.exists(m+d+"_6layer1.csv"):
            pass
        else:
            main()
        combine()
